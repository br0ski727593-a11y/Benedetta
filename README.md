...
<head>
    ...
    <title>Customizable Medical Quiz</title>
    <style>
        :root {
            --primary: #2563eb;
...
<div class="app-container">
    ...
    <div id="setup-view" class="setup-screen hidden">
        <h1>Medical Quiz Setup</h1>
        <p>There are <span id="total-available" style="font-weight:bold;">0</span> questions available.</p>
        
        <div class="input-group">
            <label for="question-count">How many questions would you like?</label>
            <input type="number" id="question-count" min="1" value="10">
        </div>

        <button class="btn" onclick="startNewQuiz()">Start Quiz</button>
        
        <div style="margin-top: 20px;">
            <button class="btn-outline" onclick="resumeQuiz()" id="resume-btn" style="display:none;">Resume Previous Session</button>
        </div>
    </div>
    ...
    <div id="quiz-view" class="hidden">
        <div class="header">
            ...
            <button class="btn-outline" onclick="exitToSetup()">New Quiz</button>
        </div>
